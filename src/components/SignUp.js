...
const SignUp = () => {
  ...
  return (
    <div className='Register'>
        ...
        <tr>
            <td ><input className='textbox' type="text" value={email} onChange={(e) => setEmail(e.target.value)}  placeholder='Email'/>
        </td>
        ...
        <tr>
            ...
            <td ><input className='textbox' type="password" value={password} onChange={(e) => setPassword(e.target.value)}  placeholder='Password'/>
        </td>
        </tr>
